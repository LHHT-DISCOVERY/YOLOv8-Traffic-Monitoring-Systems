...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            print("---------------------------Boxx ban đầu ", box.xyxy[0])
            print("---------------------------class ban đầu " , box.cls[0])
    ...
    print("----------------------shape resultsTracker", resultsTracker.shape, " ---------------- ", classes_array.shape)
    print("----------------------shape resultsTracker shape", resultsTracker.shape[0], " ---------------- ",
          classes_array.shape)
    try:
